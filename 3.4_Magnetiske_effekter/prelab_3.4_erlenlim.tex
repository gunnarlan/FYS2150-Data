...
\title{Prelab 3.4 Magnetiske Effekter} \author{Erlend Lima\\ erlenlim}
...
\item B
  % Oppgave 6
\item Se vedlagt fil for funksjon. Nedenfor er et kjøreeksempel for \(f\approx
  1\).

  \begin{lstlisting}[float]
[Dpar,Dort] = avmagnetiseringsfaktor(1.0000001)
