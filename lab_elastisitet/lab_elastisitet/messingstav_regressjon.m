...
% Massekalibrering
m_presisjon = [2.004 1.002 0.501]
m_egentlig = [2 1 0.5]
fit = regress(m_egentlig', abs(m_egentlig-m_presisjon)')

% Korriger grovmasse for systematisk 
m = 0:0.5:3.5;
grovmasse = [2.015 1.012 0.501]
grovmasse = grovmasse - predict(grovmasse)
m = [0 grovmasse(3) grovmasse(2) grovmasse(3)+grovmasse(2) grovmasse(1) grovmasse(1)+grovmasse(3)...
     grovmasse(1)+grovmasse(2) sum(grovmasse)]
