...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Initialiser %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
duration = 30; % antall sekunder vi skal måle
...
periods=diff(time(risingEdge(2:1:end))); %finn tid mellom annenhver risingEdge
...
plot(time(risingEdge(1:end-1)),threshold*ones(1,...
    length(risingEdge(1:end-1))),'o'), hold off
xlabel('tid (s)'),ylabel('spenning (V)')
figure(2), plot(time(risingEdge(1:1:end-2)),periods,'*')
xlabel('tid (s)'),ylabel('periode (s)')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%% Lagre data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = 'Avansert_maaling_oscilliator_5.mat';
save(filename,'data','risingEdge','periods','meanperiod','stdofmeanperiod')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
delta_m = sqrt(2)*std(periods)/sqrt(length(periods)-1)/meanperiod * 2210.3